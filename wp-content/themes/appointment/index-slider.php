		...
		<div class="item active">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide1.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('北京音泰思计算机技术有限公司','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('音泰思（IntaSect）命名源自“intersection”（交叉点）。交叉又是指各种文化与意见的融合，代表不同要素和文化交汇时所产生的新能量而得名。','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="http://localhost/wordpress/公司介绍" class="slide-btn-sm"><?php _e('了解我们','appointment'); ?></a></div>		
			</div>
		</div>  
		<div class="item">
